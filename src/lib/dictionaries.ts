...
const kn: Dictionary = {
  ...
  personal_details: {
    ...
    pan_label: { en: 'PAN Number', regional: 'ಪ್ಯಾన్ ಸಂಖ್ಯೆ' },
    pan_placeholder: { en: 'ABCDE1234F', regional: 'ABCDE1234F' },
    ...
    consent_description: { en: 'I hereby consent to LoanSwift fetching my credit information and other details for the purpose of this loan application.', regional: 'ಈ ಸಾಲದ ಅರ್ಜಿಯ ಉದ್ದೇಶಕ್ಕಾಗಿ ನನ್ನ ಕ್ರೆಡಿಟ್ ಮಾಹಿತಿ ಮತ್ತು ಇತರ ವಿವರಗಳನ್ನು ಪಡೆಯಲು ನಾನು ಲೋನ್‌ಸ್ವಿಫ್ಟ್‌ಗೆ ಈ ಮೂಲಕ ಸಮ್ಮತಿಸುತ್ತೇನೆ.' },
  ...
  kfs: {
    ...
    description: { en: 'Please review and accept your final loan details.', regional: 'ದಯವಿಟ್ಟು ನಿಮ್ಮ ಅಂತಿమ ಸಾಲದ ವಿವರಗಳನ್ನು ಪರಿಶೀಲಿಸಿ ಮತ್ತು ಒಪ್ಪಿಕೊಳ್ಳಿ.' },
