...
const en: Dictionary = {
  ...
  e_mandate: {
    ...
    unable_description: { en: 'Your loan application has been successfully approved.\n\nApplication ID: <Application ID>\n\nWe noticed that the auto-debit setup could not be completed digitally. This may happen if net banking or digital authorization is not available.\n\nOur relationship manager will contact you shortly to help you complete the remaining steps and guide you further.', regional: 'Your loan application has been successfully approved.\n\nApplication ID: <Application ID>\n\nWe noticed that the auto-debit setup could not be completed digitally. This may happen if net banking or digital authorization is not available.\n\nOur relationship manager will contact you shortly to help you complete the remaining steps and guide you further.' },
    app_id: { en: 'Application ID', regional: 'Application ID' },
...
const hi: Dictionary = {
  ...
  e_mandate: {
    ...
    unable_title: { en: 'Assisted Support Required', regional: 'सहायता प्राप्त समर्थन आवश्यक' },
    unable_description: { en: 'Your loan application has been successfully approved.\n\nApplication ID: <Application ID>\n\nWe noticed that the auto-debit setup could not be completed digitally. This may happen if net banking or digital authorization is not available.\n\nOur relationship manager will contact you shortly to help you complete the remaining steps and guide you further.', regional: 'आपका ऋण आवेदन सफलतापूर्वक स्वीकृत हो गया है।\n\nआवेदन आईडी: <Application ID>\n\nहमने देखा कि ऑटो-डेबिट सेटअप डिजिटल रूप से पूरा नहीं किया जा सका। यह तब हो सकता है जब नेट बैंकिंग या डिजिटल प्राधिकरण उपलब्ध न हो।\n\nहमारे संबंध प्रबंधक शेष चरणों को पूरा करने में आपकी सहायता करने और आपको आगे मार्गदर्शन करने के लिए शीघ्र ही आपसे संपर्क करेंगे।' },
    app_id: { en: 'Application ID', regional: 'आवेदन आईडी' },
...
const mr: Dictionary = {
  ...
  e_mandate: {
    ...
    unable_title: { en: 'Assisted Support Required', regional: 'सहाय्यक समर्थनाची आवश्यकता आहे' },
    unable_description: { en: 'Your loan application has been successfully approved.\n\nApplication ID: <Application ID>\n\nWe noticed that the auto-debit setup could not be completed digitally. This may happen if net banking or digital authorization is not available.\n\nOur relationship manager will contact you shortly to help you complete the remaining steps and guide you further.', regional: 'तुमचा कर्ज अर्ज यशस्वीरित्या मंजूर झाला आहे.\n\nअर्ज आयडी: <Application ID>\n\nआम्ही पाहिले की ऑटो-डेबिट सेटअप डिजिटल पद्धतीने पूर्ण होऊ शकला नाही. नेट बँकिंग किंवा डिजिटल प्राधिकरण उपलब्ध नसल्यास असे होऊ शकते.\n\nआमचे संबंध व्यवस्थापक तुम्हाला उर्वरित चरण पूर्ण करण्यात मदत करण्यासाठी आणि तुम्हाला पुढे मार्गदर्शन करण्यासाठी लवकरच संपर्क साधतील.' },
    app_id: { en: 'Application ID', regional: 'अर्ज आयडी' },
...
const te: Dictionary = {
  ...
  e_mandate: {
    ...
    unable_title: { en: 'Assisted Support Required', regional: 'సహాయక మద్దతు అవసరం' },
    unable_description: { en: 'Your loan application has been successfully approved.\n\nApplication ID: <Application ID>\n\nWe noticed that the auto-debit setup could not be completed digitally. This may happen if net banking or digital authorization is not available.\n\nOur relationship manager will contact you shortly to help you complete the remaining steps and guide you further.', regional: 'మీ లోన్ దరఖాస్తు విజయవంతంగా ఆమోదించబడింది.\n\nఅప్లికేషన్ ఐడి: <Application ID>\n\nఆటో-డెబిట్ సెటప్ డిజిటల్‌గా పూర్తి కాలేదని మేము గమనించాము. నెట్ బ్యాంకింగ్ లేదా డిజిటల్ అధికారం అందుబాటులో లేకపోతే ఇది జరగవచ్చు.\n\nమా రిలేషన్‌షిప్ మేనేజర్ మిగిలిన దశలను పూర్తి చేయడంలో మీకు సహాయం చేయడానికి మరియు మీకు తదుపరి మార్గనిర్దేశం చేయడానికి త్వరలో మిమ్మల్ని సంప్రదిస్తారు.' },
    app_id: { en: 'Application ID', regional: 'అప్లికేషన్ ఐడి' },
...
const kn: Dictionary = {
  ...
  e_mandate: {
    ...
    unable_title: { en: 'Assisted Support Required', regional: 'ಸಹಾಯದ ಬೆಂಬಲ ಅಗತ್ಯವಿದೆ' },
    unable_description: { en: 'Your loan application has been successfully approved.\n\nApplication ID: <Application ID>\n\nWe noticed that the auto-debit setup could not be completed digitally. This may happen if net banking or digital authorization is not available.\n\nOur relationship manager will contact you shortly to help you complete the remaining steps and guide you further.', regional: 'ನಿಮ್ಮ ಸಾಲದ ಅರ್ಜಿಯನ್ನು ಯಶಸ್ವಿಯಾಗಿ ಅನುಮೋದಿಸಲಾಗಿದೆ.\n\nಅರ್ಜಿ ಐಡಿ: <Application ID>\n\nಆಟೋ-ಡೆಬಿಟ್ ಸೆಟಪ್ ಅನ್ನು ಡಿಜಿಟಲ್ ಆಗಿ ಪೂರ್ಣಗೊಳಿಸಲು ಸಾಧ್ಯವಾಗಲಿಲ್ಲ ಎಂದು ನಾವು ಗಮನಿಸಿದ್ದೇವೆ. ನೆಟ್ ಬ್ಯಾಂಕಿಂಗ್ ಅಥವಾ ಡಿಜಿಟಲ್ ದೃಢೀಕರಣ ಲಭ್ಯವಿಲ್ಲದಿದ್ದರೆ ಇದು ಸಂಭವಿಸಬಹುದು.\n\nನಮ್ಮ ಸಂಬಂಧ ವ್ಯವಸ್ಥಾಪಕರು ಉಳಿದ ಹಂತಗಳನ್ನು ಪೂರ್ಣಗೊಳಿಸಲು ನಿಮಗೆ ಸಹಾಯ ಮಾಡಲು ಮತ್ತು ನಿಮಗೆ ಮತ್ತಷ್ಟು ಮಾರ್ಗದರ್ಶನ ನೀಡಲು ಶೀಘ್ರದಲ್ಲೇ ನಿಮ್ಮನ್ನು ಸಂಪರ್ಕಿಸುತ್ತಾರೆ.' },
    app_id: { en: 'Application ID', regional: 'ಅರ್ಜಿ ಐಡಿ' },
